...
plt.close('all') 
imagen = io.imread('obj3_45cm.jpg')#imagen original
...
rgbkmean = color.lab2rgb(kmeans)
gris = color.rgb2gray(rgbkmean)
plt.figure('bina'), plt.imshow(gris, cmap='gray')
